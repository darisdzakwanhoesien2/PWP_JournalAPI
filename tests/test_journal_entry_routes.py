...
#         self.assertEqual(response.status_code, 201)
#         self.assertIn("Journal entry created", response.get_json()["message"])
...
#             "content": "Content for another entry",
#             "tags": ["tag1"],
#             "sentiment_score": 0.9,
#             "sentiment_tag": ["joy"]
#         }, headers={"Authorization": f"Bearer {token}"})
...
#         data = response.get_json()
#         self.assertTrue(len(data) > 0)
#         self.assertIn("Another Test Entry", data[0]["title"])
...
#         self.assertEqual(update_response.status_code, 200)
#         self.assertIn("Journal entry updated", update_response.get_json()["message"])
...
#         delete_response = self.client.delete(f"/entries/{entry_id}", headers={"Authorization": f"Bearer {token}"})
#         self.assertEqual(delete_response.status_code, 200)
#         self.assertIn("Journal entry deleted", delete_response.get_json()["message"])
